...
void loop()
{
  ...
  for (ledNumber = 2; ledNumber <= 15; ledNumber++) // Blink LED 2 - 15 ON / OFF
  {
    ...
    {
        Serial.print("Continuing for loop with ledNumber == ");
...
Continuing for loop with ledNumber == 3
Turn on ledNumber 3
Turn off ledNumber 3
Continuing for loop with ledNumber == 4
Turn on ledNumber 4
Turn off ledNumber 4
Continuing for loop with ledNumber == 5
Turn on ledNumber 5
Turn off ledNumber 5
Continuing for loop with ledNumber == 6
Turn on ledNumber 6
Turn off ledNumber 6
Continuing for loop with ledNumber == 7
Turn on ledNumber 7
Turn off ledNumber 7
Continuing for loop with ledNumber == 8
Turn on ledNumber 8
Turn off ledNumber 8
Continuing for loop with ledNumber == 9
Turn on ledNumber 9
Turn off ledNumber 9
Continuing for loop with ledNumber == 10
Turn on ledNumber 10
Turn off ledNumber 10
Continuing for loop with ledNumber == 11
Turn on ledNumber 11
Turn off ledNumber 11
Continuing for loop with ledNumber == 12
Turn on ledNumber 12
Turn off ledNumber 12
Continuing for loop with ledNumber == 13
Turn on ledNumber 13
Turn off ledNumber 13
Continuing for loop with ledNumber == 14
Turn on ledNumber 14
Turn off ledNumber 14
Continuing for loop with ledNumber == 15
